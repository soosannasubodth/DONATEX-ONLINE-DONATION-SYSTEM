...
export default function MyVerifiedReports() {
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:8000/api/ngo/reports/verified/", {
            ...
            <div key={report.id} style={styles.reportCard}>
              ...
              {expandedId === report.id && (
                <div style={styles.reportDetails}>
                  ...
                  <p style={styles.verifiedBadge}>✓ Verified by Admin</p>
                </div>
              )}
            </div>
          ))}
